...
namespace IIS.Postamat4
{
    ...
    public class Постамат : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat4.Статусы fСтатус;
        
        private IIS.Postamat4.СлужбаДоставки fСлужбаДоставки;
        
        private IIS.Postamat4.DetailArrayOfЯчейка fЯчейка;
        ...
        public virtual IIS.Postamat4.Статусы Статус
        {
            get
            {
                ...
                IIS.Postamat4.Статусы result = this.fСтатус;
        ...
        [PropertyStorage(new string[] {
                "СлужбаДоставки"})]
        [NotNull()]
        public virtual IIS.Postamat4.СлужбаДоставки СлужбаДоставки
        {
            get
            {
                ...
                IIS.Postamat4.СлужбаДоставки result = this.fСлужбаДоставки;
        ...
        public virtual IIS.Postamat4.DetailArrayOfЯчейка Ячейка
        {
            get
            {
                ...
                {
                    this.fЯчейка = new IIS.Postamat4.DetailArrayOfЯчейка(this);
                }
                IIS.Postamat4.DetailArrayOfЯчейка result = this.fЯчейка;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПостаматE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПостаматE", typeof(IIS.Postamat4.Постамат));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПостаматL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПостаматL", typeof(IIS.Postamat4.Постамат));
                }
            }
        }
    }
