...
namespace IIS.Postamat4
{
    ...
    public class Ячейка : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat4.Постамат fПостамат;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Postamat4.Постамат.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Постамат"})]
        public virtual IIS.Postamat4.Постамат Постамат
        {
            get
            {
                ...
                IIS.Postamat4.Постамат result = this.fПостамат;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЯчейкаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЯчейкаE", typeof(IIS.Postamat4.Ячейка));
                }
            }
        }
    }
    ...
    public class DetailArrayOfЯчейка : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Postamat4.DetailArrayOfЯчейка members)

        // *** End programmer edit section *** (IIS.Postamat4.DetailArrayOfЯчейка members)
        ...
        /// </summary>
        public DetailArrayOfЯчейка(IIS.Postamat4.Постамат fПостамат) : 
                base(typeof(Ячейка), ((ICSSoft.STORMNET.DataObject)(fПостамат)))
        {
        }
        
        public IIS.Postamat4.Ячейка this[int index]
        {
            get
            {
                return ((IIS.Postamat4.Ячейка)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Postamat4.Ячейка dataobject)
        {
