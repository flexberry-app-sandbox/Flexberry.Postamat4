...
namespace IIS.Postamat4
{
    ...
    public class Транзакция : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat4.Оплата fОплата;
        
        private double fСумма;
        
        private IIS.Postamat4.Пользователь fПользователь;
        ...
        public virtual IIS.Postamat4.Оплата Оплата
        {
            get
            {
                ...
                IIS.Postamat4.Оплата result = this.fОплата;
        ...
        [PropertyStorage(new string[] {
                "Пользователь"})]
        [NotNull()]
        public virtual IIS.Postamat4.Пользователь Пользователь
        {
            get
            {
                ...
                IIS.Postamat4.Пользователь result = this.fПользователь;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТранзакцияE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТранзакцияE", typeof(IIS.Postamat4.Транзакция));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТранзакцияL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТранзакцияL", typeof(IIS.Postamat4.Транзакция));
                }
            }
        }
    }
