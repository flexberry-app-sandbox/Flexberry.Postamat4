...
namespace IIS.Postamat4
{
    ...
    public class Посылка : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat4.Логистика fЛогистика;
        
        private IIS.Postamat4.Хранение fХранение;
        ...
        public virtual IIS.Postamat4.Статус Статус
        {
            get
            {
                ...
                IIS.Postamat4.Статус result = this.fСтатус;
        ...
        [PropertyStorage(new string[] {
                "Логистика"})]
        [NotNull()]
        public virtual IIS.Postamat4.Логистика Логистика
        {
            get
            {
                ...
                IIS.Postamat4.Логистика result = this.fЛогистика;
        ...
        [PropertyStorage(new string[] {
                "Транзакция"})]
        [NotNull()]
        public virtual IIS.Postamat4.Транзакция Транзакция
        {
            get
            {
                ...
                IIS.Postamat4.Транзакция result = this.fТранзакция;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Postamat4.Хранение.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Хранение"})]
        public virtual IIS.Postamat4.Хранение Хранение
        {
            get
            {
                ...
                IIS.Postamat4.Хранение result = this.fХранение;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПосылкаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПосылкаE", typeof(IIS.Postamat4.Посылка));
                }
            }
        }
    }
    ...
    public class DetailArrayOfПосылка : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Postamat4.DetailArrayOfПосылка members)

        // *** End programmer edit section *** (IIS.Postamat4.DetailArrayOfПосылка members)
        ...
        /// </summary>
        public DetailArrayOfПосылка(IIS.Postamat4.Хранение fХранение) : 
                base(typeof(Посылка), ((ICSSoft.STORMNET.DataObject)(fХранение)))
        {
        }
        
        public IIS.Postamat4.Посылка this[int index]
        {
            get
            {
                return ((IIS.Postamat4.Посылка)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Postamat4.Посылка dataobject)
        {
